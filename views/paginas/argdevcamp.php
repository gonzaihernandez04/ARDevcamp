<main class="argdevcamp">
    <h2 class="nombre-pagina argdevcamp__heading text-center"><?php include_once __DIR__ . '/../templates/nombre-pagina.php'; ?></h2>
    ...
    <div class="argdevcamp__grid">
        <div class="argdevcamp__imagen" <?php aos_animacion()?> >
            <picture>
                ...
                <img width="230" height="300" loading="lazy" src="build/img/sobre_devwebcamp.jpg" alt="Imagen argdevcamp">
            </picture>
        </div>
